        ...
        <div class="flex h-16 justify-between">
            <div class="flex">
                ...
                <div class="hidden space-x-4 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('trainingsessions.index')" :active="request()->routeIs('trainingsessions.index')">
            ...
            <div class="md:hidden flex flex-row space-x-4">
                <!-- Hamburger -->
                ...
                <div :class="{ 'block': open, 'hidden': !open }" class="z-50">
                    <div class="mt-2 space-y-1 rounded-lg bg-gray-200 pt-2 drop-shadow-lg dark:bg-gray-700">
                        ...
                        <x-responsive-nav-link :href="route('trainingsessions.index')" :active="request()->routeIs('trainingsessions.index')">
                            {{ __('Training Sessions') }}
                        </x-responsive-nav-link>
